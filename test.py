...
def parse_args():
    ...
    parser.add_argument('--tag', default='test', help='tag of training')
    ...
    parser.add_argument('--resume', default='./checkpoint/best_model.pth', help='the path of resume training model')
